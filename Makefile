...
%.o: %.c
	@$(CC) $(CFLAGS) -c $< -o $@
	@echo "\033[1;90m Compiling Source:\033[0m \033[1;36m$<\033[0m"
	@printf "    \033[1;32m⚙️  Output:\033[0m %-20s \033[1;90m[object file]\033[0m\t\033[1;94m🔍\033[1;90mDependencies verified.\033[0m\n" "$@"
